...
A project lead or committer can create a new release by clicking menu:Committer Commands[Create a new release] on the project page. This opens a dialog requesting that a date and name be specified. Both of these values can be changed later. 
