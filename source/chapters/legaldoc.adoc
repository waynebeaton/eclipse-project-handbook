...
The `\{date}` is either a year or a range of years with the first and last years of the range separated by a comma (e.g. "`2004`" or "`2004, 2017`"). The first year is when the contents of the file were first created and the last year is when the contents were last modified. 
