...
.Eclipse Public License 1.0 Copyright and License Header template
[source]
----
/******************************************************************
...
.Alternative Eclipse Public License 1.0 Copyright and License Header template
[source]
----
/********************************************************************
...
If you have any questions or concerns, please mailto:license@eclipse.org[contact] the staff of the Eclipse Foundation.
