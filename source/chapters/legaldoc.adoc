...
* Describe the legal part of the process for accepting contributions, e.g. point to the the http://www.eclipse.org/legal/ECA.php[Eclipse Contributor Agreement] (ECA) and https://www.eclipse.org/legal/DCO.php[Developer Certificate of Origin] (DCO); and
