...
https://www.eclipse.org/legal/Trademark_Transfer_Agreement.pdf[Trademark
Transfer Agreement]).
...
"Eclipse Graphical Modeling Framework" are equally understandable.
...
are used in URLs like http://www.eclipse.org/<shortname>, project
...
(e.g. “Eclipse Woolsey SDK”).

Most open source projects produce products that share the project name.
...
Eclipse Projects must host all project content on an eclipse.org domain,
expecially the official/primary website for project-related information,
...
software does and how to get it.
...
The user portal is not a replacement for a developer portal which takes
...
non-eclipse.org domain with these considerations:

* Ownership of the domain name must be transferred to the Eclipse
Foundation;
* The domain must be regarded and treated as a user community portal;
* The first and most prominent reference to an Eclipse Project or
...
* All references to Eclipse Project names must be prefixed with
“Eclipse”;
* The website must include trademark attributions for all Eclipse
Foundation trademarks used on the site (see below); and
* Contributors must be directed to the eclipse.org site for information
regarding contribution or related development activities.

User-focused portals must include a prominent text paragraph or sidebar
...
Project Management Infrastructure (PMI)] tool. Projects using alternate
...
Nothing in this Eclipse Foundation policy statement shall be interpreted
