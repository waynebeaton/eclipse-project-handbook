...
but must be approved by the {emoEmail}[EMO] subject to the following considerations:
...
conventions (e.g. *Woolsey(TM) Labs*). Contact {emoEmail}[EMO] to request an
exception.
...
contact the {emoEmail}[EMO]. Other organizations looking for information
