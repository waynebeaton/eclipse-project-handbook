...
Our list of the most common licenses approved for use by third-party code redistributed by Eclipse Foundation Projects is http://www.eclipse.org/org/documents/licenses.php[here]. This list is not exhaustive. If you have any questions, please contact license@eclipse.org.
