...
Use the _Nominate a Project Lead_ link in the _Committer Tools_ block on the project's <<pmi,management page>> to start a project lead election.
...
PMC _Leads_ are are not elected. They are vetted by the EMO, approved by the Eclipse Board of Directors, and appointed by the EMO/ED.
