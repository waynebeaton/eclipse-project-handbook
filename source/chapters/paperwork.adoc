...
Committers must also their employers consent to their participation in 
...
_Member Committer Agreement_, and one for everybody else.
...
that are members of the Eclipse Foundation to 
...
cannot provide a signed 
MCA, then the committer will have to complete an Individual Committer Agreement and 
...
* The committer for member company that has not signed a Member Committer Agreement;
...
If the committer is self employed, an owner of your their company, or
have full ownership or part ownership in another company and have the
...
What happens if I do not fill out the paperwork?::
	If you do not fill out the paperwork, then you don't get your credentials for write-access to the
