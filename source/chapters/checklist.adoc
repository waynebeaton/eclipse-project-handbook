...
Release metadata is specified and maintained using the <<pmi, Project Management Interface>>. Project teams are required to create a metadata entry for every official release (including major, minor, and service releases).
