...
Before you commit any code into your project repository, you must submit your project's <<ip-initial-contribution,_initial contribution_>> and third party content for review by the Eclipse Intellectual Property (IP) Team. 
